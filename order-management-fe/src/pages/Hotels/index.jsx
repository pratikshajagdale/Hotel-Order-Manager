    ...
    return (
        <>
            ...
            <div className="text-end mx-4 my-3 ">
                <Button style={{ background: "#198754" }} className="d-flex border-none gap-2 ms-auto" onClick={() => setCreateHotelModal(true)}>
            ...
            <OTMModal
                ...
                description={{
                    ...
                    customerCareNumber: { name: "customerCareNumber", type: "text", label: "Customer Care Number", className: "col-6" },
